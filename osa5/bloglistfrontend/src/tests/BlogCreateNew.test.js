...
describe('Testing BlogCreateNew component', () => {
  ...
  beforeEach(() => {
    container = render(
    <BlogCreateNew user={user} updateBlogs={mockHandler} handleLogout={mockHandler} handleMessage={mockHandler} handleErrorMessage={mockHandler} handleErrors={mockHandler} isToggled={isFormToggled} unToggle={mockHandler} />
    ).container;
  });
